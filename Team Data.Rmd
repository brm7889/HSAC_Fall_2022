...
plot(mlb_hhi_sums_w$hhi, mlb_hhi_sums_w$`Win %`)
...
plot(mlb_hhi_sums_w$total_salary_relative, mlb_hhi_sums_w$`Win %`)
...
plot(nba_hhi_sums_w$hhi, nba_hhi_sums_w$pct)
...
plot(nba_hhi_sums_w$total_salary_relative, nba_hhi_sums_w$pct, main = "X", xlab = "Relative Salary")
...
plot(nba_hhi_sums_w$total_salary_relative, nba_hhi_sums_w$hhi)
